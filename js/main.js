...
const CONTACTS = [
  ...
  { city: "CDMX Coyoacán",   tel: "+525544916610",  label: "+52 55 4491 6610", bg: `url('${BASE}/assets/coyoacan-map.jpg')`, avatar: "assets/admins/cdmx-sur.png" },
  { city: "Texcoco",         tel: "+525951019227",  label: "+52 595 101 9227", bg: `url('${BASE}/assets/texcoco-map.jpg')`, avatar: "assets/admins/texcoco.jpeg" },
  { city: "Toluca",          tel: "+527211241972",  label: "+52 721 124 1972", bg: `url('${BASE}/assets/toluca-map.jpg')`, avatar: "assets/admins/toluca.jpeg" },
  { city: "Aguascalientes",  tel: "+524493756575",  label: "+52 449 375 6575", bg: `url('${BASE}/assets/aguascalientes-map.jpg')`, avatar: "assets/admins/aguascalientes.png" },
  { city: "Tijuana",         tel: "+525633800382",  label: "+52 56 3380 0382", bg: `url('${BASE}/assets/tijuana-map.jpg')`, avatar: "assets/admins/tijuana.jpeg" },
  { city: "Chihuahua",       tel: "+524437281367",  label: "+52 443 728 1367", bg: `url('${BASE}/assets/chihuahua-map.jpg')`, avatar: "assets/admins/chihuahua.jpeg" },
  { city: "Saltillo",        tel: "+529615142722",  label: "+52 961 514 2722", bg: `url('${BASE}/assets/saltillo-map.jpg')`, avatar: "assets/admins/saltillo.jpeg" },
  { city: "Guanajuato",      tel: "+525560752450",  label: "+52 55 6075 2450", bg: `url('${BASE}/assets/guanajuato-map.jpg')`, avatar: "assets/admins/guanajuato.jpeg" },
  { city: "Hidalgo",         tel: "+527717494618",  label: "+52 771 749 4618", bg: `url('${BASE}/assets/hidalgo-map.jpg')`, avatar: "assets/admins/hidalgo.jpeg" },
  { city: "Guadalajara",     tel: "+523331075868",  label: "+52 33 3107 5868", bg: `url('${BASE}/assets/guadalajara-map.jpg')`, avatar: "assets/admins/guadalajara.jpeg" },
  { city: "Guadalajara (2)", tel: "+523310426764",  label: "+52 33 1042 6764", bg: `url('${BASE}/assets/guadalajara-map.jpg')`, avatar: "assets/admins/guadalajara2.jpeg" },
  { city: "Puerto Vallarta", tel: "+528126135747",  label: "+52 81 2613 5747", bg: `url('${BASE}/assets/puertovallarta-map.jpg')`, avatar: "assets/admins/puertovallarta.png" },
  { city: "Michoacán",       tel: "+524432372667",  label: "+52 443 237 2667", bg: `url('${BASE}/assets/michoacan-map.jpg')`, avatar: "assets/admins/michoacan.jpeg" },
  { city: "Cuernavaca",      tel: "+527771954050",  label: "+52 777 195 4050", bg: `url('${BASE}/assets/cuernavaca-map.jpg')`, avatar: "assets/admins/cuernavaca.png" },
  { city: "Monterrey",       tel: "+528110217014",  label: "+52 81 1021 7014", bg: `url('${BASE}/assets/monterrey-map.jpg')`, avatar: "assets/admins/monterrey.jpeg" },
  { city: "Monterrey (2)",   tel: "+528131174713",  label: "+52 81 3117 4713", bg: `url('${BASE}/assets/monterrey-map.jpg')`, avatar: "assets/admins/monterrey2.jpeg" },
  { city: "Puebla",          tel: "+522212704193",  label: "+52 221 270 4193", bg: `url('${BASE}/assets/puebla-map.jpg')`, avatar: "assets/admins/puebla2.jpeg" },
  { city: "Puebla (2)",      tel: "+522213598637",  label: "+52 221 359 8637", bg: `url('${BASE}/assets/puebla-map.jpg')`, avatar: "assets/admins/puebla.jpeg" },
  { city: "Querétaro",       tel: "+524422494931",  label: "+52 442 249 4931", bg: `url('${BASE}/assets/queretaro-map.jpg')`, avatar: "assets/admins/queretaro.jpeg" },
  { city: "Querétaro (2)",   tel: "+525648380194",  label: "+52 56 4838 0194", bg: `url('${BASE}/assets/queretaro-map.jpg')`, avatar: "assets/admins/queretaro2.jpeg" },
  { city: "Cancún",          tel: "+529985380764",  label: "+52 998 538 0764", bg: `url('${BASE}/assets/cancun-map.jpg')`, avatar: "assets/admins/cancun.jpeg" },
  { city: "San Luis Potosí", tel: "+524445737746",  label: "+52 444 573 7746", bg: `url('${BASE}/assets/slpotosi-map.jpg')`, avatar: "assets/admins/slpotosi.jpeg" },
  { city: "Sonora",          tel: "+526442255400",  label: "+52 644 225 5400", bg: `url('${BASE}/assets/sonora-map.jpg')`, avatar: "assets/admins/sonora.png" },  
  { city: "Xalapa",          tel: "+525531919945",  label: "+52 55 3191 9945", bg: `url('${BASE}/assets/xalapa-map.png')`, avatar: "assets/admins/xalapa.jpeg" },
  { city: "Tabasco",         tel: "+529932869704",  label: "+52 993 286 9704", bg: `url('${BASE}/assets/tabasco-map.jpg')`, avatar: "assets/admins/tabasco.jpeg" },
  { city: "Zumpango",        tel: "+525545424170",  label: "+52 55 4542 4170", bg: `url('${BASE}/assets/zumpango-map.jpg')`, avatar: "assets/admins/zumpango.jpeg" },
];
